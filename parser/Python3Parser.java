...
public class Python3Parser extends Parser {
	...
	public static class TestlistStarExprContext extends Testlist_star_exprContext {
		public List<TestContext> test() {
			return getRuleContexts(TestContext.class);
		}
		public TestContext test(int i) {
		...
		public TestlistStarExprContext(Testlist_star_exprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Python3ParserListener ) ((Python3ParserListener)listener).enterTestlistStarExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Python3ParserListener ) ((Python3ParserListener)listener).exitTestlistStarExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Python3ParserVisitor ) return ((Python3ParserVisitor<? extends T>)visitor).visitTestlistStarExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Testlist_star_exprContext testlist_star_expr() throws RecognitionException {
		...
		try {
			int _alt;
			_localctx = new TestlistStarExprContext(_localctx);
			enterOuterAlt(_localctx, 1);
			{
			setState(465);
			_errHandler.sync(this);
