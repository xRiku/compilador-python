...
StepResult run_leqi(Instr instr) {
    is[instr.o1] = is[instr.o2] <= is[instr.o3];
    pc++;
    return OKAY;
}

StepResult run_leqf(Instr instr) {
    is[instr.o1] = fs[instr.o2] <= fs[instr.o3];
    pc++;
    return OKAY;
}
...
StepResult run_geqi(Instr instr) {
    is[instr.o1] = is[instr.o2] >= is[instr.o3];
    pc++;
    return OKAY;
}

StepResult run_geqf(Instr instr) {
    is[instr.o1] = fs[instr.o2] >= fs[instr.o3];
    pc++;
    return OKAY;
}
...
StepResult step() {
    ...
    switch(instr.op) {
        ...
        case LEQi: return run_leqi(instr);
        case LEQf: return run_leqf(instr);
        case GEQi: return run_geqi(instr);
        case GEQf: return run_geqf(instr);
